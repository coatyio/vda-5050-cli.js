...
const shouldShowBanner =
    !process.argv.includes("-" + quietOptionAlias.shortName, 2) &&
    !process.argv.includes("--" + quietOptionAlias.longName, 2);
const debugOptionAlias = { shortName: "d", longName: "debug" };
const shouldDebug =
    process.argv.includes("-" + debugOptionAlias.shortName, 2) ||
    process.argv.includes("--" + debugOptionAlias.longName, 2);
